...
FetchHook fetchcart() {
  final box = GetStorage();
   final catagoriesItem = useState<List<Cartresponsemodel>?>([]);
  ...
  Future<void> fetchData() async {
    ...
    try {
      final url = '$baseurl/cart/getbyid';
      print('API URL: $url');
      ...
      if (response.statusCode == 200) {
        ...
        catagoriesItem.value = jsonData.map((item) => Cartresponsemodel.fromJson(item)).toList();
      } else {
